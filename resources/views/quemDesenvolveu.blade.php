...
<div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="container">
            <p class="textTop">Esse site foi desenvolvido por Sergio Eduardo Ferreira Filho como TCC(Trabalho de conclusão de curso) tendo como orientador Diego Barros e Silva e como co-orientador Vagner da Silva Bezerra</p>
            <div class="imagens">
                <div class="test">
                    <div class="foto"></div>
